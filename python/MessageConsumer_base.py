...
class MessageConsumer_base(CF__POA.Resource, Component, ThreadedComponent):
        ...
        def __init__(self, identifier, execparams):
            ...
            self.port_geo_in = MessageConsumerPort(thread_sleep=0.1, parent = self)
        ...
        port_geo_in = providesport(name="geo_in",
